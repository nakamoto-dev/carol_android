...
include ($_SERVER['DOCUMENT_ROOT'].'/public/chat/Chat.php');
...
if($_POST['action'] == 'insert_chat') {
	...
	$chat->insertChat($_POST['to_user_id'], $_POST['from_user_id'], $_POST['tradecode'], $_POST['chat_message']);
}
if($_POST['action'] == 'show_chat') {
	$chat->showUserChat($_POST['from_user_id'], $_POST['to_user_id'],$_POST['tradecode']);
}
