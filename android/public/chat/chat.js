$(document).ready(function(){
	...
	showUserChat(from_user_id,to_user_id,tradecode);
...
// 		var to_user_id = $(this).attr('id');
	   ...
	   // to_user_id=parseInt(from_user_id);
// 		to_user_id = to_user_id.replace(/chatButton/g, "");
		sendMessage(to_user_id,from_user_id,tradecode);
	});
	$(document).on('focus', '.message-input', function(){
		var is_type = 'yes';
		$.ajax({
			url:"https://oleumtrades.com/public/chat/chat_action.php",
			method:"POST",
...
function sendMessage(to_user_id,from_user_id,tradecode) {
    
    
    showUserChat(from_user_id,to_user_id);
	...
	$.ajax({
		url:"https://oleumtrades.com/public/chat/chat_action.php",
		method:"POST",
		data:{to_user_id:to_user_id,from_user_id:from_user_id, chat_message:message,tradecode:tradecode, action:'insert_chat'},
		dataType: "json",
		success:function(response) {
...
function showUserChat(from_user_id,to_user_id,tradecode){
	$.ajax({
		url:"https://oleumtrades.com/public/chat/chat_action.php",
		method:"POST",
		data:{to_user_id:to_user_id,from_user_id:from_user_id,tradecode:tradecode, action:'show_chat'},
		dataType: "json",
		success:function(response){
